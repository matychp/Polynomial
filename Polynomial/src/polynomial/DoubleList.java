...
public class DoubleList<E extends Comparable> implements Iterable<E> {
    ...
    /**
     * Inserta un objeto al principio de la lista. La insercion se hara solo si
     * el parametro recibido no es null.
     *
    ...
    /**
     * Inserta un objeto al final de la lista. La insercion se hara solo si el
     * parametro recibido no es null.
     *
     * @param x el objeto a almacenar en la lista.
     */
     ...
     * compareTo() para realizar las comparaciones (aunque podria usarse
     * equals()).
     *
    ...
    /**
     * Retorna (pero sin removerlo) el objeto ubicado en la posicion "index" de
     * la lista, tomando como convencion que el primer nodo esta en la posicion
     * cero. Si el index a buscar está despues de la mitad de la lista busca
     * desde el fondo para atras. Si está antes de la mitad de la lista, busca
     * desde el frente hacia adelante.
     *
     ...
     * si x no esta en la lista o si x es null o si x no es compatible con el
    ...
    /**
     * Remueve el objeto x en la posicion index de la lista. Los objetos que se
     * encontraban a su derecha en la lista se desplazan hacia la izquierda una
     * posicion. Se toma como convencion que el primer nodo esta en la posicion
     * cero.
     *
     * @param index el numero de orden del objeto a acceder.
     * @return el objeto que se encontraba en la posicion index.
     * @throws IndexOutOfBoundsException si index esta fuera de rango (index <0 || index
     * >= size() ).
     */
     ...
     * referencia al objeto que ESTA EN LA LISTA. Retorna null si x no esta en
    ...
    /**
     * Reemplaza el objeto ubicado en la posicion "index" de la lista, por el
     * objeto x que entra como parametro. Se toma como convencion que el primer
